...
m_san = {i+1:ColumnDataSource(data=dict(t=t,y=y1*(i-12))) for i in range(12)}
...
airport_select = Select(value='LAX', title='Airport', options=['LAX','SAN'])
